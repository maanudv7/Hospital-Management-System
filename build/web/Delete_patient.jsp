<%-- 
    Document   : del_patient
    Created on : 30 Jun, 2020, 6:23:40 PM
  ...
  One possible method is this->
    ...
    <div class="row register-form" style="padding-right: 0;">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form"  action="DeleteServ" style="background-color: rgba(71,186,235,0.13);padding: 55px;padding-top: 25px;padding-bottom: 25px;margin-top: 25px;margin-bottom: 25px;margin-right: 25px;margin-left: 25px;">
                <h1 style="margin-bottom: 45px;">Delete Patient</h1>
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" name="doj" type="text" value="${doj}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><input class="form-control"  name="bed" type="text" value="${bed}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><textarea class="form-control" name="add" style="height: 85px;width: 225px;" readonly> ${add} </textarea></div>
                </div>
                <div class="form-row form-group">
                ...
                </div><button class="btn btn-light submit-button" name="action" value="delete" style="margin: 0;">Delete</button></form>
        </div>
    </div>
