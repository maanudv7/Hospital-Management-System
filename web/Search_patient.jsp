<%-- 
    ...
    Created on : 2 Jul, 2020, 12:15:30 AM
  ...
  One possible method is this->
    ...
    <div class="row register-form" style="padding-right: 0;">
        <div class="col-md-8 offset-md-2">
            <form class="custom-form"  action="SearchServ" style="background-color: rgba(71,186,235,0.13);padding: 55px;padding-top: 25px;padding-bottom: 25px;margin-top: 25px;margin-bottom: 25px;margin-right: 25px;margin-left: 25px;">
                <h1 style="margin-bottom: 45px;">Search Patient</h1>
                
                <input type="hidden" name="source" value="search">        
                
                <div class="form-row form-group" style="margin-bottom: 5px;">
                    <div class="col-sm-4 label-column">
                        <label class="col-form-label" for="name-input-field" style="font-size: 16px;padding-right: 5px;">Patient SSN ID</label>
                    </div>
                    <div class="col-sm-6 input-column">
                        <input class="form-control" type="text" name="ssnid" value="${ssnid}" style="background-color: #ffffff;" required="">
                    </div>
                </div>
                
                <button class="btn btn-light submit-button"  type="submit" style="margin: 10px;padding: 10px;">Get</button>
                ...
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="name" value="${name}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" type="text" name="age" value="${age}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-6 input-column"><input class="form-control" name="dateofadmission" type="text" value="${dateofadmission}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><input class="form-control"  name="bedtype" type="text" value="${bedtype}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><textarea class="form-control" name="addr" style="height: 85px;width: 225px;" readonly>${addr}</textarea></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><input class="form-control" name="state" type="text" value="${state}" readonly></div>
                </div>
                <div class="form-row form-group">
                    ...
                    <div class="col-sm-4 input-column"><input class="form-control" name="city" type="text" value="${city}" readonly></div>
                </div>
